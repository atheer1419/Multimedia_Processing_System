...
//  }
  ...
  public static Sound blendSoundsForLab() {
    Sound sound1 =
       new Sound(FileChooser.getMediaPath("aah.wav"));
    Sound sound2 =
       new Sound(FileChooser.getMediaPath("bassoon-c4.wav"));
    ...
    for (int index = 0; index < 10000; index++) {
      value = (int) ((sound1.getSampleValueAt(index + 5000) * 0.5) +
                     (sound2.getSampleValueAt(index) * 0.5));
      target.setSampleValueAt(index + 5000,value);
    }

    // copy the next 20,000 samples from sound2 into the target
    for (int index=10000; index < 20000; index++)
      target.setSampleValueAt(index + 15000,
                              sound2.getSampleValueAt(index));
